  ...
  return (
    <section className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">Click to learn more</p>
      </div>
      <div className="space-y-6">
        {/* Cardworks */}
        <div 
          onClick={() => setIsModalOpen(true)}
          className="flex items-start space-x-4 p-4 rounded-lg border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 cursor-pointer"
        >
          <div className="flex-shrink-0">
            <div className="h-16 w-16 relative rounded-full overflow-hidden border-4 border-gray-100 shadow-sm bg-white flex items-center justify-center">
              <Image
          ...
          <div className="flex-grow">
            <div className="flex justify-between items-start">
              <div>
                <h3 className="text-lg font-medium">Cardworks</h3>
                <p className="text-gray-500">Seasonal Associate, Data Visualization</p>
              </div>
              <span className="text-gray-500">May 2024 - August 2024</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <div>
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-xl font-semibold">Cardworks</h3>
              <p className="text-gray-600">Seasonal Associate, Data Visualization</p>
              <p className="text-gray-500">May 2024 - August 2024</p>
            </div>
          </div>
